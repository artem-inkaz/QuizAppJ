package ui.smartpro.quizappj.data.sqlite;
...
//основной класс для работы с данными в БД
public class NotificationDbController {
    ...
    //добавляет новую строку данных в БД
    ...
    //олучает только непрочитанные уведомления путем добавления переменной selectionArgs в курсор
